...
if (isset($_POST["btnDispatch"]))
{
	...
	$patrolcarDispatched = $_POST["chkPatrolcar"];  //array of patrolcar being dispatch from post back
  ...
  incident_location, incident_desc, incident_status_id) VALUES('".$_POST['callerName']."', '".$_POST['contactNo']."', '".$_POST['incidentType']."', '".$_POST[
  'location']."', '".$_POST['incidentDesc']."', $incidentStatus)";
    if ($conn->query($sql)===FALSE) {
	  echo "Error: " . $sql . "<br>" . $conn->error;
	}
	
	//retrieve incident_id for the newly inserted inserted incident
$incidentId=mysqli_insert_id($conn);;

//update pattrolcar status table and add into dispatch table
...
// retrieve from patrolcar table these patrol cars that are 2:Patrol or 3:Free
